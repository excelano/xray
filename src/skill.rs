...
//! instruction — `xray --install-skill` — true everywhere.
//!
...
const FILES: &[(&str, &str)] = &[
    ("SKILL.md", include_str!("../skills/xray/SKILL.md")),
    ("reference.md", include_str!("../skills/xray/reference.md")),
];
...
mod tests {
    ...
    fn the_stamp_sits_under_the_frontmatter_not_inside_it() {
        ...
        assert!(out[fm_end..].contains("This skill documents xray 9.9.9"));
        // The body survives intact underneath.
        assert!(out.ends_with("# xray\n"));
    }
