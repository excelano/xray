...
**Status:** Active design, opened 2026-07-10. This session is carrying it forward. Name: `xray` (x-family; you *x-ray* a file before you operate on it). crates.io availability **not yet verified**.
